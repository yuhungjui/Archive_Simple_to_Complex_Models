      subroutine getvor2(nx,my,lev,vorg2,div,sinl)

******************************************************************************

      dimension vorg2(nx,lev,my),div(nx,lev,my),sinl(my)
...
c      do 101 i=1,nx
        ...
        vorg2(i,1,j)=voramp(n)*exp(-(dx/a)**2-(dy/b)**2)
 101  continue
      print *,'vorg2(ix,1,jy)=',vorg2(ix,1,jy)
