...
psi = stream1(Nxl,Nyl,Lx,Ly,zeta);
...
for s = 1:ntime
    ...
    if rem(tt,1) == 0
        ...
        figure(1)
        contourf(x/1000,y/1000,psi*1.e-7,V,'b') % x, y, converted to km for graph
        hold on
