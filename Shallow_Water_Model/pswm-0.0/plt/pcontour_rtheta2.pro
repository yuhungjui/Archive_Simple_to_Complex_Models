PRO PCONTOUR_RTHETA2, field, numradial, numtheta, deltar, $
      contlevels, outfile, ptitle
...
set_plot, 'ps'
device, FILENAME = outfile, /COLOR, /INCHES, XSIZE = 8.0, YSIZE = 6.0, $
