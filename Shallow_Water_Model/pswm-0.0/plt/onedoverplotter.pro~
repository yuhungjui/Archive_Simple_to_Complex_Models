PRO onedoverplotter, DATA, XPLOT, TITLES, BOUNDS, PLOTNAME
...
; TEMP FOR BUDGET
XYOUTS, 0.73, 0.86, 'MEAN', /NORMAL, CHARSIZE = 1.5, CHARTHICK = 5.0
XYOUTS, 0.73, 0.82, 'EDDY', /NORMAL, CHARSIZE = 1.5, CHARTHICK = 5.0
;XYOUTS, 0.73, 0.78, 'MEAN+EDDY', /NORMAL, CHARSIZE = 1.5, CHARTHICK = 5.0
;XYOUTS, 0.73, 0.74, 'ACTUAL', /NORMAL, CHARSIZE = 1.5, CHARTHICK = 5.0
XYOUTS, 0.73, 0.78, 'ACTUAL', /NORMAL, CHARSIZE = 1.5, CHARTHICK = 5.0
