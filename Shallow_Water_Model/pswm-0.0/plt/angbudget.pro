;
; ANGBUDGET.PRO
; Perform Angular Momentum Budget 
;

PRINT, "Running ANGBUDGET.PRO..."
...
mean_int_last = DBLARR(nr,nl)
eddy_int_last = DBLARR(nr,nl)

mean_integral = DBLARR(nr,nl)
eddy_integral = DBLARR(nr,nl)

actual_mom1 = DBLARR(nr,nl)
actual_mom2 = DBLARR(nr,nl)
